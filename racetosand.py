...
# try:
#     cursor.execute("SELECT * FROM spelare;")
#     df_golfid = pd.DataFrame(cursor.fetchall())

#     cursor.execute("SELECT * FROM competitions;")
#     df_spelschema = pd.DataFrame(cursor.fetchall())
...
#         GROUP BY spelare;
#     """)
#     df_leaderboard = pd.DataFrame(cursor.fetchall())

#     cursor.execute("SELECT * FROM leaderboard;")
#     df_leaderboard_chart = pd.DataFrame(cursor.fetchall())
...
#         GROUP BY spelare;
#     """)
#     df_böter = pd.DataFrame(cursor.fetchall())

#     cursor.execute("SELECT * FROM tot_böter WHERE datum = (SELECT MAX(datum) FROM tot_böter);")
#     df_tot_böter = pd.DataFrame(cursor.fetchall())

# except Error as e:
#     st.error("Något gick fel med datahämtningen... Kontakta IT.")
#     st.stop()
